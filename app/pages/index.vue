<template>
	<div class="page">
		...
		<section class="hero">
			<NuxtImg
				src="https://tlp-media.storage.yandexcloud.net/nikita.jpg"
				alt="Никита Зуянов"
				width="300"
				height="300"
				class="hero__photo"
		...
		<div class="sections">
			<section class="section">
				...
				<p class="section__text text-body">
					...
					Сейчас — старший фронтенд-разработчик в Ozon. Люблю, когда под капотом всё сложно, а снаружи — просто и красиво. В свободное время учусь быть папой.
				</p>
			</section>
...
const BIRTH_DATE = new Date(1995, 1, 14) // 14 февраля 1995
const CAREER_START_YEAR = 2018

const age = computed(() => yearsSince(BIRTH_DATE))
const experience = computed(() => new Date().getFullYear() - CAREER_START_YEAR)
...
/* Background glow effect like vite.dev */
.glow {
	position: fixed;
	top: -40%;
	left: 50%;
