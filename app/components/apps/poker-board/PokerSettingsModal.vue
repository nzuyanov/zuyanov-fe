				...
				<div class="body">
					...
					<section class="section">
						...
						<div class="blindsInfo">
							...
							<span class="blindsLevel">({{
									store.gameState.currentBlindLevel + 1
								}} из {{ store.allBlindLevels.length }})</span>
						</div>
						<div class="actions">
							<button
								class="actionBtn"
					...
					<section v-if="eliminatedPlayers.length === 0 && playersWithRebuys.length === 0"
							 class="section sectionEmpty">
...
<script setup lang="ts">
	...
	import { Fa6ArrowDown, Fa6ArrowUp, Fa6Forward } from 'vue-icons-plus/fa6'
