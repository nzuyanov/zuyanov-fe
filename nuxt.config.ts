...
export default defineNuxtConfig({
	...
	app: {
		head: {
			...
			title: 'Зуянов Никита Сергеевич',
			link: [
				{rel: 'icon', type: 'image/svg+xml', href: '/favicon.svg'},
			],
			meta: [
				{name: 'description', content: 'Зуянов Никита Сергеевич — Frontend разработчик'},
			],
			noscript: [
				{
					innerHTML: `
<style>.page{display:none!important}.noscript{max-width:520px;margin:120px auto;padding:0 24px;font-family:system-ui,sans-serif;text-align:center;color:rgba(255,255,255,.87)}.noscript__title{font-size:4rem;font-weight:900;letter-spacing:-.02em;background:linear-gradient(135deg,#bd34fe,#41d1ff);background-clip:text;-webkit-background-clip:text;-webkit-text-fill-color:transparent;margin:0 0 24px}.noscript__text{font-size:1.125rem;line-height:1.7;color:rgba(255,255,255,.6);margin:0 0 24px}.noscript__links{list-style:none;padding:0;display:flex;flex-wrap:wrap;justify-content:center;gap:12px}.noscript__links a{padding:8px 20px;border-radius:999px;border:1px solid rgba(255,255,255,.1);background:rgba(255,255,255,.04);color:#c75aff;text-decoration:none;font-size:.9rem}.noscript__links a:hover{border-color:#bd34fe;color:#41d1ff}</style>
<div class="noscript">
